...
class WelcomePage extends AbstractWelcomePage {
  ...
  changeLoginPromptVisibility = isOpened => {
    this.setState({ isLoginPromptOpen: isOpened });
  }

  changeRegisterWindowVisibility = isOpened => {
    this.setState({ isRegisterWindowOpen: isOpened });
  }
            ...
            {localStorage.getItem('username')
              ...
              : <div className='login-buttons-group'>
                <button
                  ...
                  onClick={() => { this.changeLoginPromptVisibility(true); }}>
                  Войти
                </button>
                <button
                  className='login-button'
                  onClick={() => { this.changeRegisterWindowVisibility(true); }}>
                  Регистрация
                </button>
              </div>
            }
